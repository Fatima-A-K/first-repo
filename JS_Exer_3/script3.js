...
function onClick(){     //funktion, damit sich die Farbe im Kreis beim Anklicken des Kreises ändert u nd beim neu laden der Seite
...
stone.document.addEventListener('click', onClick);
